class Enzymes:
    ...
    def __init__(self):
        ...
        self.enzymes = {
            ...
            'leukocyte elastase': {'cleavage rule': '(?<=[ALIJVX])(?!P)', 'PSIID': 'MS:1001915',
                                   'cleavage sites': 'ALIJVX'},
            'proline endopeptidase': {'cleavage rule': '(?<=[HKRX][PX])(?!P)', 'PSIID': 'MS:1001916'
                , 'cleavage sites': 'HKRX'},
            'glutamyl endopeptidase': {'cleavage rule': '(?<=[DBEZX])', 'PSIID': 'MS:1001917',
                                       'cleavage sites': 'DBEZX'},
...
PGATK_ENZYMES = Enzymes()
PGATK_ALPHABET = "ACDEFGHIKLMNPQRSTVWYBJOUXZ"
