...
//        fileGTFYeast = inputGZfile.getAbsolutePath();
        ...
        File inputGZfile = TestUtils.unGzip(new File(Objects.requireNonNull(PepGenomeToolTest.class.getClassLoader().getResource("taxonomies/Pan_paniscus.panpan1.1.94.gtf.gz")).toURI()));
...
//    }
    ...
    public void bonoboTest() throws IOException {
        ...
        List<List<String>> bedLines = TestUtils.getBedLines(outputBed);
        Assert.assertEquals(4, bedLines.size());
